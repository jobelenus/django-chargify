...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('chargify_component', (
            ...
            ('unit_name', self.gf('django.db.models.fields.CharField')(max_length=75, null=True, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('update_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('price', self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=15, decimal_places=2)),
            ('product_family', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
