...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field components on 'Subscription'
        db.create_table('chargify_subscription_components', (
        ...
        db.create_unique('chargify_subscription_components', ['subscription_id', 'component_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field components on 'Subscription'
        db.delete_table('chargify_subscription_components')
    ...
    models = {
        ...
        'chargify.subscription': {
            ...
            'components': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['chargify.Component']", 'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
