...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('chargify_product', 'product_family', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.product_family'
        db.delete_column('chargify_product', 'product_family')
